...
// End-to-end prove+verify under the default (retention-tuned system) allocator. Repeated to
// catch any cross-run state corruption. (Replaces the former `test_zk_alloc` arena regression
// test; the bump arena and its phase ceremony were removed in favor of a robust allocator.)
#[test]
